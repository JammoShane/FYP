      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="car_entry.html">Car Entry</a>
            </li>
            <li class="nav-item active">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img
              src="images/idea.jpg"
              alt="image of a Bughatti Chiron"
              class="img-fluid"
            />
          </div>
          <div class="col-md-6">
            ...
            <button
              ...
              onclick="location.href = 'customize.html' "
            >
              Customize!
            </button>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <button
              type="button"
              class="btn btn-primary"
              onclick="location.href = 'car_entry.html' "
            >
              Enter!
            </button>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <button
              type="button"
              class="btn btn-primary"
              onclick="location.href = 'bill.html' "
            >
              Generate!
            </button>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <button
              type="button"
              class="btn btn-primary"
              onclick="location.href = 'database.html' "
            >
              View!
            </button>
          </div>
